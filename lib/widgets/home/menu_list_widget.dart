...
class MenuListWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncValue = ref.watch(productListsProvider);
              ...
              children: [
                AspectRatio(
                  ...
                  child: Stack(
                    children: [
                      Positioned.fill(
                        child: CustomImageProvider(image: item.image),
                      ),
                      Positioned(
                        top: 8,
                        left: 8,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '₹${(item.price * 86).toStringAsFixed(2)}',
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          // onPressed: () =>
                          //     ref.read(basketProvider.notifier).init(item),
                          onPressed: () {},
                          style: TextButton.styleFrom(
